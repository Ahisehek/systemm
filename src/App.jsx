  ...
  return (
    <div className="overflow-auto scrollbar-hide h-screen">
      <Router>
        ...
        {/* ✅ ToastContainer FIXED (outside Routes) */}
        <ToastContainer position="top-right" autoClose={2000} />
        ...
        <Routes>
          ...
          <Route path="/dashbord" element={<Dash />}>
            ...
            <Route path="master/unit" element={<St />} />
            <Route path="master/site" element={<Repo />} />
            <Route path="master/profile" element={<Pro />} />
            <Route path="master/gst" element={<Gst />} />
            <Route path="master/fleet" element={<Fleet />} />
            <Route path="master/itemgroup" element={<Igroup />} />
