    ...
    <div className="bg-slate-800 text-white min-h-screen p-3 sm:p-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white text-black p-4 sm:p-6 rounded-xl">
          <input value={fullName} onChange={(e) => setFullName(e.target.value)} className="border p-2 w-full mb-2" />
          <input value={sortName} onChange={(e) => setSortName(e.target.value)} className="border p-2 w-full mb-2" />
          <button className="w-full sm:w-auto bg-slate-800 text-white px-4 py-2 rounded">Save</button>
        </div>

        <div className="bg-white text-black p-4 sm:p-6 rounded-xl overflow-x-auto">
