...
//             <div className="   justify-center text-black">This is bank</div>
//             <div className=" justify-center  ">
//               <label htmlFor="" className="text-slate-700">Bank:</label>
//               <input
//                 type="text"
...
//           <div className="  shadow-sky-600 shadow">
...
//                       {/* <th className="border border-white ">Bank Name</th> */}
//                     </tr>
//                   </thead>
//                   <tbody>
//                     {[...bankList]
...
//                           name?.toString().toLowerCase().startsWith(bankName.toLowerCase());
...
//                             .startsWith(bankName.toLowerCase()) &&
//                           bankName !== "";
